...
public class ProbeAddressesOpenCLTest {
    ...
    */
    ...
    public void createKeys_bitsLowerThan25_use32BitNevertheless(int bitSize) throws IOException, UnknownKernelModeException, InvalidWorkSizeException {
        new OpenCLPlatformAssume().assumeOpenCLLibraryLoadableAndOneOpenCL2_0OrGreaterDeviceAvailable();
    ...
    @Test
    @OpenCLTest
    public void createKeys_bitsLowerThanGridSize_useMoreNevertheless() throws IOException, UnknownKernelModeException, InvalidWorkSizeException {
        new OpenCLPlatformAssume().assumeOpenCLLibraryLoadableAndOneOpenCL2_0OrGreaterDeviceAvailable();
        ByteBufferUtility byteBufferUtility = new ByteBufferUtility(false);
        KeyUtility keyUtility = new KeyUtility(MainNetParams.get(), byteBufferUtility);
    ...
    @Test
    @OpenCLTest
    public void setSrcPrivateKeyChunk_aBigIntegerHaveLeadingZeros_Copy32BytesOnlyAndNoExceptionThrown() throws IOException, UnknownKernelModeException, InvalidWorkSizeException {
        new OpenCLPlatformAssume().assumeOpenCLLibraryLoadableAndOneOpenCL2_0OrGreaterDeviceAvailable();
    ...
    @Test
    @OpenCLTest
    public void hashcatOpenClGrid() throws IOException, UnknownKernelModeException, InvalidWorkSizeException {
        new OpenCLPlatformAssume().assumeOpenCLLibraryLoadableAndOneOpenCL2_0OrGreaterDeviceAvailable();
