...
__kernel void generate_chunk_until_third_sha256(__global uchar *r, __global const u32 *k){
    ...
    // calculating offset to write results in byte buffer
    int r_offset_bytes_private_key = (PRIVATE_KEY_BYTES + PUBLIC_KEY_BYTES_WITH_PARITY + SHA256_HASH_BYTES_LEN + RIPEMD160_HASH_BYTES + SHA256_HASH_BYTES_LEN + SHA256_HASH_U32_LEN) * work_item_id;
